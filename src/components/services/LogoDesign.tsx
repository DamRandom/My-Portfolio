...
export default function LogoDesignServices() {
  const packages = [
    {
      title: "Básico",
      price: 49.9,
      description: "Perfecto para emprendedores que buscan una identidad visual inicial.",
      features: [
        "1 propuesta de logo",
        "2 revisiones",
        "Entrega en formato JPG y PNG",
    ...
    },
    {
      title: "Profesional",
      price: 89.9,
      description: "Diseño completo con variantes, tipografía personalizada y paleta de color.",
      features: [
        "2 propuestas iniciales",
        "4 revisiones",
        "Logo en versiones vertical, horizontal e ícono",
        "Entrega en formatos JPG, PNG y PDF",
  ...
  const handleContact = (pkg: string, price: number) => {
    ...
    const mensaje = `Hola Damian, me interesa el paquete ${pkg} de Diseño de Logos. Precio: S/${price.toFixed(
      2
    )}`;
